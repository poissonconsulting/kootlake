...
- Deprecate
  [`kl_estimate_na()`](https://poissonconsulting.github.io/kootlake/reference/kl_estimate_na.md)
  using lifecycle.
...
- Updated fishery data to include licenses sold and license holder
  survey data
...
- Added
  [`kl_estimate_na()`](https://poissonconsulting.github.io/kootlake/reference/kl_estimate_na.md)
  function to estimate missing values using a linear model
